...
forecast_with_dates = [{'date': date.strftime('%Y-%m-%d'), 'revenue': revenue} for date, revenue in zip(forecast_index, forecast)]
...
# plt.plot(forecast_index, forecast, color='red', linestyle='--', marker='o', label='Forecasted Revenue (Next 25 days)')
# plt.xlabel('Date')
